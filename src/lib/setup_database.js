...
var supabaseUrl = process.argv[2];
var supabaseKey = process.argv[3];
...
function setupDatabase() {
    return __awaiter(this, void 0, void 0, function () {
        var investmentsError, investmentHistoryError;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, supabase.rpc('exec', {
                        sql: "\n      BEGIN;\n      CREATE TABLE investments (\n        id UUID PRIMARY KEY DEFAULT gen_random_uuid(),\n        user_id UUID REFERENCES auth.users(id),\n        ticker TEXT NOT NULL,\n        quantity INT NOT NULL,\n        purchase_price DECIMAL(10, 2) NOT NULL,\n        purchase_date DATE NOT NULL,\n        created_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL\n      );\n      COMMIT;\n    ",
                    })];
                case 1:
                    investmentsError = (_a.sent()).error;
                    if (investmentsError) {
                    ...
                    return [4 /*yield*/, supabase.rpc('exec', {
                            sql: "\n      BEGIN;\n      CREATE TABLE investment_history (\n        id UUID PRIMARY KEY DEFAULT gen_random_uuid(),\n        investment_id UUID REFERENCES investments(id),\n        date DATE NOT NULL,\n        price DECIMAL(10, 2) NOT NULL,\n        created_at TIMESTAMP WITH TIME ZONE DEFAULT timezone('utc'::text, now()) NOT NULL\n      );\n      COMMIT;\n    ",
                        })];
                case 2:
                    investmentHistoryError = (_a.sent()).error;
